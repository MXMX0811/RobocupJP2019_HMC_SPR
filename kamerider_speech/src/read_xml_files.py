...
def read_gesture_file(path='/home/zmx/catkin_ws/src/kamerider_speech/CommonFiles/Gestures.xml'):
...
def read_location_xml(path='/home/zmx/catkin_ws/src/kamerider_speech/CommonFiles/Locations.xml'):
    location_xml = {}
    xml_file = et.parse(path)
    root = xml_file.getroot()
...
def read_names_xml(path='/home/zmx/catkin_ws/src/kamerider_speech/CommonFiles/Names.xml'):
    name_xml = {}
    xml_file = et.parse(path)
    root = xml_file.getroot()
...
def read_object_xml(path='/home/zmx/catkin_ws/src/kamerider_speech/CommonFiles/Objects.xml'):
    object_xml = {}
    xml_file = et.parse(path)
    root = xml_file.getroot()
