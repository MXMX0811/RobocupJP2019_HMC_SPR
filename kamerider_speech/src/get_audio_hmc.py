...
class get_audio():
    def __init__(self):
        ...
        self.project_name = '/home/keaixin/catkin_ws/src/kamerider_speech/sounds/hmc_record/gpsr'
        self.count = 0
    ...
    def play_signale_sound(self):
        chunk = 1024
        # 打开 .wav 音频文件
        f = wave.open('/home/keaixin/catkin_ws/src/kamerider_speech/sounds/question_start_signal.wav', 'rb')
        # 初始化pyaudio
        p = pyaudio.PyAudio()
        # 打开一个stream
        stream = p.open(
