...
int main(int argc, char* argv[])
{
    ...
    // 订阅唤醒语音识别的信号    
    ros::Publisher pub_recognition_result = n.advertise<std_msgs::String>("/baidu_to_control", 1);  
    printf("Sleeping...");
    int count=0;
    while(ros::ok())
    {
        ...
        if (wakeupFlag){
            printf("Wakeup...");
            sound_client.playWave("/home/zmx/catkin_ws/src/kamerider_speech/sounds/question_start_signal.wav");
            int ret = MSP_SUCCESS;
